...
def resnet18(pretrained, checkpoint, pooling, **kwargs):
    """Constructs a ResNet-18 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], checkpoint, pooling, **kwargs)
    if pretrained:
...
def resnet34(pretrained, checkpoint, pooling, **kwargs):
    """Constructs a ResNet-34 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [3, 4, 6, 3], checkpoint, pooling, **kwargs)
    if pretrained:
...
def resnet50(pretrained, checkpoint, pooling, **kwargs):
    """Constructs a ResNet-50 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], checkpoint, pooling, **kwargs)
    if pretrained:
...
def resnet101(pretrained, checkpoint, pooling, **kwargs):
    """Constructs a ResNet-101 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], checkpoint, pooling, **kwargs)
    if pretrained:
...
def resnet152(pretrained, checkpoint, pooling, **kwargs):
    """Constructs a ResNet-152 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 8, 36, 3], checkpoint, pooling, **kwargs)
    if pretrained:
